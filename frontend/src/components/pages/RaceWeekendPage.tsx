...
export default function RaceWeekendPage() {
    const t = useTranslations('RaceWeekendPage');
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-6 border-b border-white/5 gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <h2 className="text-4xl font-bold text-white tracking-tight flex items-center gap-3">
                            {t('results', { session: SESSION_NAMES[activeSession] })}
                        </h2>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <span className="material-symbols-outlined text-[16px]">analytics</span> {t('deepAnalysis')}
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="xl:col-span-8 flex flex-col gap-8">
                        ...
                        <div className="bg-[#232429] border border-[#303238] rounded-2xl shadow-xl overflow-hidden">
                            <div className="flex justify-between items-center p-5 border-b border-[#303238]">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1a1b1e] border border-[#303238]">
                                        ...
                                        <span className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">{t('soft')}</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1a1b1e] border border-[#303238]">
                                        <span className="w-2 h-2 rounded-full bg-[#ffcc00]"></span>
                                        <span className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">{t('medium')}</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#1a1b1e] border border-[#303238]">
                                        <span className="w-2 h-2 rounded-full bg-[#f2f2f7]"></span>
                                        <span className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">{t('hard')}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-[#1c1d21]/50 text-[10px] text-slate-500 uppercase tracking-widest font-bold border-b border-[#303238]">
                                            <th className="py-4 text-center w-12">{t('pos')}</th>
                                            <th className="py-4 pl-4">{t('driver')}</th>
                                            <th className="py-4">{t('team')}</th>
                                            <th className="py-4">{t('time')}</th>
                                            <th className="py-4">{t('gap')}</th>
                                            <th className="py-4 text-center">{t('laps')}</th>
                                            <th className="py-4 text-center">{t('tire')}</th>
                                            <th className="py-4 text-center hidden md:table-cell">{t('sectors')}</th>
                                        </tr>
                                    </thead>
                            ...
                            <div className="p-4 bg-[#1c1d21]/30 text-center border-t border-[#303238]">
                                <button className="text-[10px] text-slate-500 hover:text-white transition-colors uppercase tracking-widest font-bold flex items-center justify-center gap-1 w-full m-auto">
                                    {t('showFullGrid')} <span className="material-symbols-outlined text-[16px]">expand_more</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#232429] border border-[#303238] rounded-2xl p-6 shadow-xl">
                            <div className="flex justify-between items-end mb-8">
                                <div>
                                    <h3 className="text-sm font-bold text-white uppercase tracking-widest">{t('longRunAnalysis')}</h3>
                                    <p className="text-[11px] text-slate-500 mt-1">{t('longRunDesc')}</p>
                                </div>
                                <div className="flex gap-3">
                                    <button className="text-[10px] bg-[#1a1b1e] border border-[#303238] rounded-lg px-3 py-1.5 font-bold text-slate-400 uppercase tracking-widest hover:text-white transition-colors">{t('soft')}</button>
                                    <button className="text-[10px] bg-primary text-white rounded-lg px-3 py-1.5 font-bold uppercase tracking-widest">{t('medium')}</button>
                                    <button className="text-[10px] bg-[#1a1b1e] border border-[#303238] rounded-lg px-3 py-1.5 font-bold text-slate-400 uppercase tracking-widest hover:text-white transition-colors">{t('hard')}</button>
                                </div>
                            </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className="relative flex flex-col group p-5 bg-[#1a1b1e] rounded-xl border border-[#303238] overflow-hidden">
                                        ...
                                        <div className="flex items-center gap-2 mb-3 mt-1">
                                            ...
                                            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">{item.team}</span>
                                        </div>
                                        <div className="text-2xl font-bold text-white font-mono mt-auto">{item.time}</div>
                                        <div className="text-[10px] text-slate-500 mt-1">{t('avgDev')} <span className="text-green-500">{item.diff}</span></div>

                                        <div className="w-full bg-[#2a2b30] rounded-full h-1 mt-4 overflow-hidden">
                                            <div className="h-full" style={{ backgroundColor: item.color, width: item.badge ? '100%' : i === 0 ? '98%' : i === 2 ? '90%' : '85%' }}></div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="xl:col-span-3 flex flex-col gap-8">
                        ...
                        <div className="bg-[#232429] border border-[#303238] rounded-2xl flex flex-col overflow-hidden shadow-xl">
                            <div className="p-5 border-b border-[#303238]">
                                <h3 className="text-sm font-bold text-white uppercase tracking-widest">{t('sectorDominance')}</h3>
                            </div>
                            <div className="relative p-6 h-64 flex items-center justify-center bg-[#1a1b1e]">
                                ...
                                <div className="absolute bottom-4 left-4 right-4 space-y-3">
                                    <div className="flex justify-between items-center text-xs">
                                        <span className="text-slate-500 uppercase font-bold tracking-widest text-[9px]">{t('sector1')}</span>
                                    ...
                                    <div className="flex justify-between items-center text-xs">
                                        <span className="text-slate-500 uppercase font-bold tracking-widest text-[9px]">{t('sector2')}</span>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex justify-between items-center text-xs">
                                        <span className="text-slate-500 uppercase font-bold tracking-widest text-[9px]">{t('sector3')}</span>
                                        <div className="flex items-center gap-2">
                        ...
                        <div className="bg-[#232429] border border-[#303238] rounded-2xl p-6 shadow-xl">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-sm font-bold text-white uppercase tracking-widest">{t('speedTrap')}</h3>
                            ...
                            <div className="flex flex-col gap-0">
                                {[
                                    ...
                                    <div key={item.pos} className="flex items-center justify-between border-b border-[#303238] py-4 first:pt-0 last:border-0 last:pb-0">
                                        <div className="flex items-center gap-4 flex-1">
                                            <div className="w-4 font-bold text-slate-500 text-[11px] text-center">{item.pos}</div>
                                            <div className="flex-1 max-w-[140px]">
                                                <div className="text-[10px] font-bold text-white uppercase mb-2 whitespace-nowrap overflow-hidden text-ellipsis">{item.name}</div>
                        ...
                        {/* Weather */}
                        <div className="bg-[#232429] border border-[#303238] rounded-2xl p-6 shadow-xl">
                            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">{t('trackConditions')}</h3>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="text-center bg-[#1a1b1e] border border-[#303238] rounded-xl p-4">
                                    ...
                                    <div className="text-[9px] text-slate-500 uppercase tracking-widest mt-1">{t('trackTemp')}</div>
                                </div>
                                <div className="text-center bg-[#1a1b1e] border border-[#303238] rounded-xl p-4">
                                    ...
                                    <div className="text-[9px] text-slate-500 uppercase tracking-widest mt-1">{t('airTemp')}</div>
                                </div>
                                <div className="text-center bg-[#1a1b1e] border border-[#303238] rounded-xl p-4">
                                    ...
                                    <div className="text-[9px] text-slate-500 uppercase tracking-widest mt-1">{t('humidity')}</div>
                                </div>
                                <div className="text-center bg-[#1a1b1e] border border-[#303238] rounded-xl p-4">
                                    ...
                                    <div className="text-[9px] text-slate-500 uppercase tracking-widest mt-1">{t('wind')}</div>
                                </div>
                            </div>
                        </div>
